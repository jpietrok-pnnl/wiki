 ...
 */
var claim_wiki, personaEnd, settings, setup, update_footer;
...
update_footer = function(ownerName, isAuthenticated) {
  ...
  if (isAuthenticated) {
    ...
    $('footer > #security > #logout').click(function(e) {
      var myInit;
      e.preventDefault();
      myInit = {
        method: 'GET',
    ...
    if (!isClaimed) {
      ...
      return $('footer > #security > #claim').click(function(e) {
        e.preventDefault();
        return claim_wiki();
      });
    } else {
      if (settings.usingPersona) {
        ...
        return $('footer > #security > #addAltAuth').click(function(e) {
          var w;
          e.preventDefault;
          return w = WinChan.open({
            ...
            if (err) {
              ...
              return fetch('/auth/addAltAuth', myInit).then(function(response) {
