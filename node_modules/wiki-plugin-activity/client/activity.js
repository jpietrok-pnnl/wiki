 ...
 */
var _, bind, createElement, diff, emit, escape, h, open_conversation, parse, patch, setDefaults,
...
bind = function($item, item) {
  ...
  display = function(query, pages) {
    ...
    if (query.searchTerm) {
      header.push(h('p', subHeadStyle, "searching for \"" + query.searchTerm + "\""));
    }
    if (query.since) {
      header.push(h('p', subHeadStyle, "since " + ((new Date(query.since)).toDateString())));
    }
    if (query.twins > 0) {
      header.push(h('p', subHeadStyle, "more than " + query.twins + " twins"));
    }
  ...
  merge = function(query, neighborhoodSites) {
